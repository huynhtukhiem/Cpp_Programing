// Tính tổng, tích các phần tử có trong danh sach
...
int Tinh_tong(Node* head){
    ...
    Node* temp = head;            // Con trỏ tạm để duyệt
    while(temp != nullptr){       // Lặp qua từng node
        sum += temp->data;        // Cộng giá trị node vào tổng
...
int main(){
    ...
    cout << "Tong cac phan tu trong danh sach lien ket: " << Tinh_tong(head);
